    ...
    with open(args.input, "r", encoding="utf-8") as f:
        for line in f:
            ...
            with torch.no_grad():
                ...
                # If model is CRF wrapper it may return .predictions
                if hasattr(out, "predictions"):
                    # predictions is a list of label id lists per batch
            ...
            # CREDIT_CARD: require >=12 digits
            cc_spans = find_numeric_spans(text, min_digits=12)
            for s, e in cc_spans:
            ...
            # PHONE: require >=7 digits
            phone_spans = find_numeric_spans(text, min_digits=7)
